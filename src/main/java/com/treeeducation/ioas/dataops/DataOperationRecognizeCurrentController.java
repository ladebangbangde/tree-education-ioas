...
public class DataOperationRecognizeCurrentController {
    private final ImageRecognitionService imageRecognitionService;

    public DataOperationRecognizeCurrentController(ImageRecognitionService imageRecognitionService) {
        this.imageRecognitionService = imageRecognitionService;
    }

    @PostMapping("/{assetId}/recognize-current")
    @PreAuthorize("isAuthenticated()")
    public ApiResponse<ImageRecognitionDtos.Response> recognizeCurrent(@PathVariable Long assetId,
